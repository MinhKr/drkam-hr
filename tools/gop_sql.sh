#!/usr/bin/env bash
# Gộp 9 file migration thành web/supabase/setup_project_moi.sql để dán một lần
...
FILES=(0001_init 0002_seed_catalogs 0004_view_ung_vien 0005_view_lich_pv 0006_view_onboard 0007_luu_tru_dung 0008_bucket_cv 0009_stopped_at_khi_nhap 0010_danh_muc_crud)
